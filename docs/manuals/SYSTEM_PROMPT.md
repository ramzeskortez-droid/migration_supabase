...
16. Ты и пользователь должны активно использовать файл `conductor/backlog.md` для фиксации идей, задач на будущее и технического долга. Если в ходе обсуждения возникает идея, которая не будет реализована немедленно, ты **обязан** предложить (или самостоятельно, если есть разрешение) добавить её в этот файл.
