...
- **Варианты (Победители):** (В раскрытом виде) Для каждой позиции отображаются выбранные менеджеры. 
  - **Цена:** Отображается финальная рублевая цена для клиента (`adminPrice`).
  - **Срок:** Отображается рассчитанный срок с учетом логистической добавки (`clientDeliveryWeeks`).
