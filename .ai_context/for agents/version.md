...
- **Buyer UI:** Поле "Кол-во" в карточке товара заменено с редактируемого ввода на статичную метку (label), чтобы избежать путаницы с возможностью изменения запрашиваемого количества.
