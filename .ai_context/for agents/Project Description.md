...
- **AI-ассистент:** Распознавание текста заявки (email, мессенджер) и автоматическое заполнение таблицы позиций и метаданных заказа.
- **Финансовое ядро:** Централизованное управление курсами (Юань/Доллар/Рубль) и автоматический расчет итоговой цены с учетом веса и логистики.
