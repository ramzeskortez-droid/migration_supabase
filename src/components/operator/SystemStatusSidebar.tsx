...
export const SystemStatusSidebar: React.FC<SystemStatusSidebarProps> = ({ displayStats, children }) => {
  return (
    <aside className="w-80 bg-white border-l border-slate-200 p-0 flex flex-col shrink-0 overflow-hidden h-full">
      <div className="flex-1 overflow-y-auto custom-scrollbar">
        ...
        {/* Рендерим вложенный виджет почты */}
        <div className="p-4">
            {children}
        </div>
        ...
        <div className="p-6 bg-slate-50/50">
          ...
          <div className="h-48 overflow-y-auto bg-white border border-slate-200 rounded-lg p-3 shadow-sm font-mono text-[10px] leading-relaxed text-slate-600 space-y-1.5 custom-scrollbar">
