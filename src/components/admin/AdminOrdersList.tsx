...
const AdminOrderRow = memo(({ 
    ...
    else if (currentStatus === 'КП отправлено') { statusBorderColor = 'border-l-amber-400'; statusBgColor = 'bg-amber-50/30 hover:bg-amber-50/50'; }
                            ...
                            <div className="flex flex-wrap md:flex-nowrap justify-end gap-2 md:gap-3 mt-6 pt-4 border-t border-slate-200">
                                {isEditing ? (
                                    ...
                                    {currentStatus === 'В обработке' && (
                                        <div className="flex items-center gap-2">
                                            <label className="flex items-center gap-2 cursor-pointer bg-slate-50 px-3 py-3 rounded-xl border border-slate-200 select-none hover:bg-slate-100 transition-colors">
                                                <input 
                                                    type="checkbox" 
                                                    checked={isManual} 
